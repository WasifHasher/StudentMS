            ...
            <div class="row justify-content-center">
                <div class="col-7 bg-light rounded" style="height:340px;">
                    ...
                    <form action="/SaveRecord" method="POST">
                        ...
                        <div class="form-group my-3">
                            <input type="text" class="form-control w-100 py-2 rounded ps-3" placeholder="syllabus" name="syllabus">
                            @error('syllabus')
                            <div class="text-danger">{{$message}}</div>
                        ...
                        <div class="form-group my-3">
                            <input type="text" class="form-control w-100 py-2 rounded ps-3" placeholder="duration" name="duration">
                            @error('duration')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
