...
<body style="background: rgb(217, 213, 213)">
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-7 bg-light rounded" style="height:490px;">
                    <h2 class="py-2">Add Teacher Informations</h2>
                    <form action="/TeacherData" method="POST">
                        @csrf
                        ...
                        <div class="form-group my-3">
                            <input type="text" class="form-control w-100 py-2 rounded ps-3" placeholder="Qualification" name="Qualification">
                            @error('Qualification')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group my-3">
                            <input type="text" class="form-control w-100 py-2 rounded ps-3" placeholder="Experience" name="Experience">
                            @error('Experience')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
